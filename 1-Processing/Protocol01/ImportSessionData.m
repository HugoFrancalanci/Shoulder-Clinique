...
rawDob = cell2mat(table2array(tSession(5,2)));
try
    Patient.dob = datetime(rawDob,'InputFormat','dd.MM.yyyy');
catch
    Patient.dob = datetime(rawDob,'InputFormat','dd-MMM-yyyy','Locale','en_US');
end
...
rawDate = cell2mat(table2array(tSession(29,2)));
try
    Session.date = datetime(rawDate,'InputFormat','dd.MM.yyyy');
catch
    Session.date = datetime(rawDate,'InputFormat','dd-MMM-yyyy','Locale','en_US');
end
